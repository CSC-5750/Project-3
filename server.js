...
// Define our six time slots (adjust as needed)
const timeSlots = [
...
app.post('/register', (req, res) => {
  // Get form data; if confirm flag is set, then the student confirmed change
  ...
  db.query(seatQuery, [time_slot], (err, results) => {
    ...
    db.query(checkQuery, [id], (err, rows) => {
      ...
      if (rows.length > 0) {
        // Update existing registration (change slot)
...
// GET: Display list of registered students
